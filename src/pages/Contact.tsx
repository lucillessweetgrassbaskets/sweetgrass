...
const ContactDetail = ({ icon: Icon, title, content }: { icon: React.ComponentType<any>; title: string; content: string }) => (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-8">
            Have questions about our products or interested in placing a custom order? We'd love to hear from you.
          </p>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <a href="mailto:lucilles.sweetgrassbaskets@yahoo.com" className="text-gray-600 hover:text-amber-600">
